					...
					<div class="content">
						<table width="100%">
							<tr>
								<td>
									<h3>Hi {{fnama}}</h3>
									<p>Sorry, our system has canceled the order: {{produk_nama}} ({{invoice_code}}) because you didn't confirm the order for the past 12 hours.</p>
									<p>&nbsp;</p>
									<p>&nbsp;</p>
									<p>Best wishes</p>
