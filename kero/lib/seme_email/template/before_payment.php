...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body bgcolor="#FFFFFF">
		<table class="head-wrap" bgcolor="#ededed" width="100%" summary="header content">
			<tr>
				<th><h4>Waiting for payment</h4></th>
			</tr>
		</table>
					...
					<div class="content">
						<table width="100%">
							<tr>
								<td>
									<h3>Hi {{fnama}}</h3>
									<p>Please, finish your payment for this following product {{product name}} immediately.</p>
									<p>if you don't complete your payment order within the next 30 minutes,</p>
									<p>you must repeat your order.</p>
									<p>&nbsp;</p>
									<p>&nbsp;</p>
									<p>Best wishes</p>
