...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body bgcolor="#FFFFFF">
		<table class="head-wrap" bgcolor="#ededed" width="100%" summary="header content">
			<tr>
				<th><h4>Your order has Expired</h4></th>
			</tr>
		</table>
					...
					<div class="content">
						<table width="100%">
							<tr>
								<td>
									<h3>Hi {{fnama}}</h3>
									<p>Sorry, the seller cannot process your order for invoice: {{no_invoice}}</p>
									<p>Your money will be refunded automatically.</p>
									<p>&nbsp;</p>
									<p>&nbsp;</p>
									<p>Best wishes</p>
