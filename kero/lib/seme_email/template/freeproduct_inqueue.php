...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Free product In Queue</title>
	...
	<body bgcolor="#FFFFFF">
		<table class="head-wrap" bgcolor="#ededed" width="100%" summary="header content">
			<tr>
				<th><h4>Free product In Queue</h4></th>
			</tr>
		</table>
					...
					<div class="content">
						<table width="100%">
							<tr>
								<td>
									<h3>Hi {{fnama}}</h3>
									<p class="lead">For now we have reached our limits for free product, but your product are in queue.</p>
									<p>&nbsp;</p>
									<p>Best wishes</p>
