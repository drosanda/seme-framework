					...
					<div class="content">
						<table width="100%">
							<tr>
								<td>
									<h3>Hi {{fnama}}</h3>
									<p>Your order with no invoice {{no_invoice}} has been delivered.</p>
									<p>Please confirm before the next 3 days.</p>
									<p>Otherwise our system will auto-confirm that you have received the order.</p>
									<p>&nbsp;</p>
									<p>&nbsp;</p>
									<p>Best wishes</p>
