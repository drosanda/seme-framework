						...
						<table width="100%">
							<tr>
								<td>
									...
									<p>The transaction with invoice number {{invoice_code}} has been rejected by the seller {{seller_fnama}} (ID: {{seller_id}}).</p>
									<p>Make a refund to the buyer immediately and change a status here.</p>
