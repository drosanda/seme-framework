...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body bgcolor="#FFFFFF">
		<table class="head-wrap" bgcolor="#ededed" width="100%" summary="header content">
			<tr>
				<th><h4>Delivery in progress</h4></th>
			</tr>
		</table>
					...
					<div class="content">
						<table width="100%">
							<tr>
								<td>
									<h3>Hi {{fnama}}</h3>
									<p>Your ordered product: {{produk_nama}} ({{invoice_code}}) has been sent by the seller by {{shipment_service}}.</p>
									<p>With the receipt number {{shipment_tranid}}.</p>
									<p>&nbsp;</p>
									<p>&nbsp;</p>
									<p>Best wishes</p>
