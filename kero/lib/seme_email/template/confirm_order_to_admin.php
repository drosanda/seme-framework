...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Confirmed by the Buyer</title>
	...
	<body bgcolor="#FFFFFF">
		<table class="head-wrap" bgcolor="#ededed" width="100%" summary="header content">
			<tr>
				<th><h4>Confirmed by the Buyer</h4></th>
			</tr>
		</table>
						...
						<table width="100%">
							<tr>
								<td>
									...
									<p>The transaction with invoice number {{invoice_code}} is confirmed.</p>
									<p>Please check the balance and be ready to pay the seller {{seller_fnama}} and change a status here.</p>
